...
fn expected_contract_ids(manifests: &CompatManifests) -> BTreeSet<String> {
    let mut ids = BTreeSet::from([
        ...
        "contract.requirement.SHELL-01".to_owned(),
        "contract.requirement.SHELL-02".to_owned(),
        "contract.requirement.SHELL-03".to_owned(),
        "contract.requirement.SHELL-04".to_owned(),
        "contract.requirement.SHELL-05".to_owned(),
        "contract.requirement.SHELL-06".to_owned(),
        "contract.requirement.SHELL-07".to_owned(),
